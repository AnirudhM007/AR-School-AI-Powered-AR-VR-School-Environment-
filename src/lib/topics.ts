...
const heartAnnotations: TopicAnnotation[] = [
  ...
  },
  {
    id: 'left-atrium',
    label: 'Left Atrium',
    description: 'The left atrium receives oxygen-rich blood returning from the lungs before it moves into the left ventricle.',
    position: [0.42, 0.46, 0.22],
    questionPrompt: 'What is the job of the left atrium in blood circulation?',
    meshKeywords: ['left atrium', 'atrium-left', 'atrium'],
  },
  {
    id: 'right-atrium',
    label: 'Right Atrium',
    description: 'The right atrium receives oxygen-poor blood from the body and passes it into the right ventricle.',
    position: [-0.46, 0.24, 0.18],
    questionPrompt: 'Why does the right atrium receive blood from the body first?',
    meshKeywords: ['right atrium', 'atrium-right', 'atrium'],
  },
  {
    id: 'left-ventricle',
    label: 'Left Ventricle',
    description: 'The left ventricle is the strongest chamber and pumps oxygen-rich blood through the aorta to the body.',
    position: [0.34, -0.22, 0.3],
    questionPrompt: 'Why is the left ventricle the strongest pumping chamber?',
    meshKeywords: ['left ventricle', 'ventricle-left', 'ventricle'],
  },
  {
    id: 'right-ventricle',
    label: 'Right Ventricle',
    description: 'The right ventricle pumps oxygen-poor blood to the lungs so it can pick up oxygen.',
    position: [-0.34, -0.14, 0.24],
    questionPrompt: 'What happens to blood after the right ventricle pumps it out?',
    meshKeywords: ['right ventricle', 'ventricle-right', 'ventricle'],
  },
  {
    id: 'coronary-arteries',
    label: 'Coronary Arteries',
    description: 'Coronary arteries wrap around the heart muscle and deliver oxygen-rich blood to keep it working.',
    position: [0.16, -0.58, 0.36],
    questionPrompt: 'Why do coronary arteries matter for the heart itself?',
    meshKeywords: ['coronary', 'arteries', 'artery'],
  },
];
